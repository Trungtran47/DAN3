...
import com.example.doan3.databinding.HomeNewprItemBinding

import com.example.doan3.model.ProductModel

class NewprAdapter(private val images: List<ProductModel>) : RecyclerView.Adapter<NewprAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = HomeNewprItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(private val binding: HomeNewprItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(feature: ProductModel) {
            binding.nameNew.text = feature.productName
            binding.priceNew.text = feature.price
